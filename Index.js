...
const SESSION_ID = 'levanter_275ab82f09a1be43c9be3f2da4230275b6' // Edit this line only, don't remove ' <- this symbol
...
// spawnSync('yarn', ['docker'], { cwd: 'levanter', stdio: 'inherit' }) //remove // on this line to use pmconst { spawnSync, spawn } = require('child_process')
const { existsSync, writeFileSync } = require('fs')
//read last lines!!!!!!!!!!!!!!
